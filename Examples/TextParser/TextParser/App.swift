...
//  TextParser
//
//  Created by Jaime Yesid Leon Parada on 14/05/22.
//
...
struct App : ParsableCommand {
    ...
    @Flag(name: .shortAndLong, help: "Print alternative words for each word in the input.")
    var alternatives = false
    
    @Flag(name: .shortAndLong, help: "Print names of people, places, and organizations in the input.")
    var names = false
    
    @Option(name: .shortAndLong, help: "The maximun number of alternatives to suggest")
    ...
    mutating func run() {
        ...
        if alternatives {
            print()
            print("Found the following altenatives:")
